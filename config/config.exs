...
# across all instances, since a given instance is always "responsible" for a given screen ID.)
...
config :screens,
       ...
       primary: Keyword.merge(shared_cache_options, allocated_memory: 200 * 1024 * 1024)
