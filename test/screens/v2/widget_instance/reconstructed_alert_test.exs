defmodule Screens.V2.WidgetInstance.ReconstructedAlertTest do
  ...
  describe "priority: single-line station" do
    ...
    test "downstream partial platform closure, multiple platforms", %{widget: widget} do
      widget =
        widget
    ...
    test "partial platform closure for downstream", %{widget: widget} do
      widget =
        widget
