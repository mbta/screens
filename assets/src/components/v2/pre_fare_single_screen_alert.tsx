...
const doFallbackLayout = (
  issue: string | null,
  remedy: string | null,
  pioSecondaryTextSize: string
) => (
  <>
    <img
...
const standardIssueSection = (
  ...
  <div className="alert-card__issue">
    <img className="alert-card__icon" src={imagePath("no-service-black.svg")} />
    <div>
      <div
        className={classWithModifier(
    ...
    {effect === "shuttle" ? (
      <>
        <div className="alert-card__remedy__shuttle-icons">
          <img className="alert-card__icon" src={imagePath("bus-black.svg")} />
          <img
      ...
      <>
        <img className="alert-card__icon" src={imagePath("nearby.svg")} />
  ...
  const multiLineLayout = () => {
    ...
    return (
      <div className="alert-card__content-block" ref={contentBlockRef}>
        ...
        <div className="alert-card__issue">
          <img className="alert-card__icon" src={imagePath("info.svg")} />
          <div
            className={classWithModifier(
              "alert-card__content-block__text",
              contentTextSize
...
const pillPath = (pillFilename: string) =>
  imagePath(`pills/${pillFilename}.svg`);
