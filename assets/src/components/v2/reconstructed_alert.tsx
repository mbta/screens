...
const FlexZoneAlertCard: ComponentType<AlertCardProps> = ({
  urgent,
  children,
}) => (
  <svg
    ...
    width="1064px"
    height="616px"
    viewBox="0 0 1064 616"
    xmlns="http://www.w3.org/2000/svg"
    xmlnsXlink="http://www.w3.org/1999/xlink"
  >
    <defs>
      <path
        d="M210.627417,19.372583 L29.372583,200.627417 C23.3714189,206.628581 20,214.767906 20,223.254834 L20,554 C20,571.673112 34.326888,586 52,586 L1012,586 C1029.67311,586 1044,571.673112 1044,554 L1044,42 C1044,24.326888 1029.67311,10 1012,10 L233.254834,10 C224.767906,10 216.628581,13.3714189 210.627417,19.372583 Z"
        id="path-1"
      ></path>
      <filter
        x="-3.4%"
    ...
    <g
      id="Primary-Screen-Master-Symbols"
      stroke="none"
      strokeWidth="1"
      fill="none"
      fillRule="evenodd"
    >
      <g
        id="Background-Shape-Copy"
        transform="translate(532.000000, 298.000000) scale(-1, 1) translate(-532.000000, -298.000000) "
      >
        <use
          fill="black"
          fillOpacity="1"
...
const filenameForFlexZoneIcon = (effect: string, urgent: boolean) => {
  switch (effect) {
    case "shuttle":
      return urgent
        ? "alert-widget-icon-bus--color-urgent.svg"
