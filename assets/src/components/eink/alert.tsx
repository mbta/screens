...
import BaseAlert, { Props, AlertCardProps, AlertIcon } from "Components/alert";
import LinkArrow from "Components/bundled_svg/link_arrow";
...
const propsWithStaticUrl = (props: Props): Props => ({
  ...props,
  url: "mbta.com/alerts",
});
...
const FullBodyTopScreenAlertCard: ComponentType<AlertCardProps> = ({
  children,
}) => (
  <svg
    width="1136px"
