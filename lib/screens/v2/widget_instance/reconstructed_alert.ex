defmodule Screens.V2.WidgetInstance.ReconstructedAlert do
  ...
  defp single_screen_fields(
    ...
    %__MODULE__{
      alert: %{cause: cause, updated_at: updated_at, description: description},
      now: now,
      informed_station_names: informed_station_names
    } = t
    ...
    issue =
      if region == :here do
        ...
        "#{informed_station_names}: Trains skip #{informed_platform_name} platform"
      end
  ...
  defp single_screen_fields(
       ...
       when not is_nil(informed_platform_names) and informed_platform_names != [] do
