defmodule Screens.V2.ScreenData.Layout do
  @moduledoc """
  ...
  @type non_paged ::
          {
            Template.layout(),
            %{Template.non_paged_slot_id() => WidgetInstance.t()},
            paging_metadata()
          }
  ...
  def pick_instances(candidate_instances, screen_template) do
    prioritized_instances =
      Enum.sort_by(candidate_instances, &WidgetInstance.priority/1)
  ...
  @spec resolve_paging(t(), integer() | nil) :: non_paged()
  @spec resolve_paging(t(), integer() | nil, DateTime.t()) :: non_paged()
