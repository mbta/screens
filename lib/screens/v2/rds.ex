defmodule Screens.V2.RDS do
  ...
  defp destination_state(
    ...
    presented_departures =
      Enum.filter(
        departures,
        &presented_departure?(&1, not is_nil(headways), impacted_by_alert?)
      )
  ...
  @spec combine_headway_states_for_section([RDS.Headways.t()]) :: [RDS.Headways.t()]
  ...
  @spec get_common_headsign([destination()], Route.t(), Trip.direction()) :: String.t()
